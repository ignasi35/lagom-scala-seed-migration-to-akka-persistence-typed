package org.eggsample.smello.api
...
object SmelloService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The smello service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the SmelloService.
  */
trait SmelloService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("smello")
      ...
      .withTopics(
        topic(SmelloService.TOPIC_NAME, greetingsTopic _)
